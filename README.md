...
> The project version mirrors the extension version its patch signatures were verified against: **2.1.229**.
...
- The `anthropic.claude-code` extension installed (verified against **2.1.229**; the signatures also match 2.1.220–2.1.228)
...
|---|---|---|
| `main` | 2.1.229 — newest | `f.env=v;`, `light:s,dark:s` |
