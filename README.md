...
> The project version mirrors the extension version its patch signatures were verified against: **2.1.266**.
...
- The `anthropic.claude-code` extension installed (verified against **2.1.266**; the signatures also match 2.1.259, the only other bundle still verifiable on disk — earlier releases need their own `v<version>` branch)
...
|---|---|---|
| `main` | 2.1.266 — newest | `N.env=M;`, `light:W,dark:W` |
