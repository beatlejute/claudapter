...
> The project version mirrors the extension version its patch signatures were verified against: **2.1.251**.
...
- The `anthropic.claude-code` extension installed (verified against **2.1.251**; the signatures also match 2.1.220–2.1.250)
...
|---|---|---|
| `main` | 2.1.251 — newest | `N.env=D;`, `light:W,dark:W` |
