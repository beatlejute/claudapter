...
> The project version mirrors the extension version its patch signatures were verified against: **2.1.269**.
...
- The `anthropic.claude-code` extension installed (verified against **2.1.269**, the only bundle still on disk — that update swept both 2.1.267 and 2.1.268, so earlier releases need their own `v<version>` branch)
...
|---|---|---|
| `main` | 2.1.269 — newest | `Z.env=R;`, `light:W,dark:W` |
