...
> The project version mirrors the extension version its patch signatures were verified against: **2.1.267**.
...
- The `anthropic.claude-code` extension installed (verified against **2.1.267**; the signatures also match 2.1.266, the only other bundle still on disk — earlier releases need their own `v<version>` branch)
...
|---|---|---|
| `main` | 2.1.267 — newest | `O.env=R;`, `light:W,dark:W` |
